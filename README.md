...
Edit this document to include your answers after each question. Make sure to leave a blank line above and below your answer so it is clear and easy to read by your project manager
	...
	A way for us to understand an elements meaning and for the browsers know how to display the elements.
	...
	Cross axis, or x-axis, or vertical 

	4. Explain why git is valuable to a team of developers.

	Git is necessary to monitor and control code changes made during development across several people or teams.

	5. Define mobile-first design in your own words.

    Designing and developing for the smallest screen first and then working your way up.
